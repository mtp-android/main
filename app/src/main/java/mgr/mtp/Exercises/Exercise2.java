...
public class Exercise2 extends WizardStep {
    ...
    Button btnStart;
    TextView ex2_firstSetWeightET, ex2_firstSetRepsET, ex2_secondSetWeightET, ex2_secondSetRepsET,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ex2_secondSetRepsET = (TextView) v.findViewById(R.id.secondSet_reps);
        ex2_secondSetWeightET = (TextView) v.findViewById(R.id.secondSet_weight);

        ex2_thirdSetRepsET = (TextView) v.findViewById(R.id.thirdSet_reps);
        ex2_thirdSetWeightET = (TextView) v.findViewById(R.id.thirdSet_weight);

        ex2_fourthSetRepsET = (TextView) v.findViewById(R.id.fourthSet_reps);
        ex2_fourthSetWeightET = (TextView) v.findViewById(R.id.fourthSet_weight);

        ex2_fifthSetRepsET = (TextView) v.findViewById(R.id.fifthSet_reps);
        ex2_fifthSetWeightET = (TextView) v.findViewById(R.id.fifthSet_weight);

        getWeightFromPreferences();

        ex2_firstSetWeightET.setText(""+set1max);
        ex2_secondSetWeightET.setText(""+set2max);
        ex2_thirdSetWeightET.setText(""+set3max);
        ex2_fourthSetWeightET.setText(""+set4max);
        ex2_fifthSetWeightET.setText(""+set5max);
    ...
    View.OnClickListener showNumberPickers = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (id) {
                case R.id.editone:
                    reps.setValue(Integer.parseInt(ex2_firstSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex2_firstSetWeightET.getText().toString()));
                    break;
                case R.id.edittwo:
                    reps.setValue(Integer.parseInt(ex2_secondSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex2_secondSetWeightET.getText().toString()));
                    break;
                case R.id.editthree:
                    reps.setValue(Integer.parseInt(ex2_thirdSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex2_thirdSetWeightET.getText().toString()));
                    break;
                case R.id.editfour:
                    reps.setValue(Integer.parseInt(ex2_fourthSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex2_fourthSetWeightET.getText().toString()));
                    break;
                case R.id.editfive:
                    reps.setValue(Integer.parseInt(ex2_fifthSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex2_fifthSetWeightET.getText().toString()));
                    break;
                default:
                    break;
            }
            ...
            builder.setView(theView)
                    .setPositiveButton(R.string.confirmed, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            switch (id) {
                                case R.id.editone:
                                    ex2_firstSetRepsET.setText("" + repsValue);
                                    ex2_firstSetWeightET.setText("" + weightValue);
                                    break;
                                case R.id.edittwo:
                                    ex2_secondSetRepsET.setText("" + repsValue);
                                    ex2_secondSetWeightET.setText("" + weightValue);
                                    break;
                                case R.id.editthree:
                                    ex2_thirdSetRepsET.setText("" + repsValue);
                                    ex2_thirdSetWeightET.setText("" + weightValue);
                                    break;
                                case R.id.editfour:
                                    ex2_fourthSetRepsET.setText("" + repsValue);
                                    ex2_fourthSetWeightET.setText("" + weightValue);
                                    break;
                                case R.id.editfive:
                                    ex2_fifthSetRepsET.setText("" + repsValue);
                                    ex2_fifthSetWeightET.setText("" + weightValue);
                                    break;
                                default:
                                    break;
                            }
    ...
    private void bindDataFields() {
        ...
        int finalSet3 = Integer.parseInt(ex2_thirdSetWeightET.getText().toString());
        int finalSet4 = Integer.parseInt(ex2_fourthSetWeightET.getText().toString());
        int finalSet5 = Integer.parseInt(ex2_fifthSetWeightET.getText().toString());

        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(getContext());

        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("set"+trainingSetId+"ex2set1max", set1max >= finalSet1 ? set1max : finalSet1 + 2);
        editor.putInt("set"+trainingSetId+"ex2set2max", set2max >= finalSet1 ? set2max : finalSet2 + 2);
        editor.putInt("set"+trainingSetId+"ex2set3max", set3max >= finalSet1 ? set3max : finalSet3 + 2);
        editor.putInt("set"+trainingSetId+"ex2set4max", set4max >= finalSet1 ? set4max : finalSet4 + 2);
        editor.putInt("set"+trainingSetId+"ex2set5max", set5max >= finalSet1 ? set5max : finalSet5 + 2);
    ...
    private void getWeightFromPreferences(){
        ...
        set1max = prefs.getInt("set"+trainingSetId+"ex2set1max", 5);
        set2max = prefs.getInt("set"+trainingSetId+"ex2set2max", 5);
        set3max = prefs.getInt("set"+trainingSetId+"ex2set3max", 5);
        set4max = prefs.getInt("set"+trainingSetId+"ex2set4max", 5);
        set5max = prefs.getInt("set"+trainingSetId+"ex2set5max", 5);
