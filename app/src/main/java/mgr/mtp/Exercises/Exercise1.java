...
public class Exercise1 extends WizardStep {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (trainingSetId) {
            ...
            case 2:
                name = "Rzymski martwy ciąg";
                break;

            case 3:
                name = "Prostowanie łydek";
                break;
    ...
    View.OnClickListener showNumberPickers = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (id) {
                case R.id.editone:
                    reps.setValue(Integer.parseInt(ex1_firstSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex1_firstSetWeightET.getText().toString()));
                    break;
                case R.id.edittwo:
                    reps.setValue(Integer.parseInt(ex1_secondSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex1_secondSetWeightET.getText().toString()));
                    break;
                case R.id.editthree:
                    reps.setValue(Integer.parseInt(ex1_thirdSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex1_thirdSetWeightET.getText().toString()));
                    break;
                case R.id.editfour:
                    reps.setValue(Integer.parseInt(ex1_fourthSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex1_fourthSetWeightET.getText().toString()));
                    break;
                case R.id.editfive:
                    reps.setValue(Integer.parseInt(ex1_fifthSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex1_fifthSetWeightET.getText().toString()));
                    break;
                default:
                    break;
            }
    ...
    private void bindDataFields() {
        ...
        editor.putInt("set"+trainingSetId+"ex1set1max", set1max >= finalSet1 ? set1max : finalSet1 + 2);
        editor.putInt("set"+trainingSetId+"ex1set2max", set2max >= finalSet1 ? set2max : finalSet2 + 2);
        editor.putInt("set"+trainingSetId+"ex1set3max", set3max >= finalSet1 ? set3max : finalSet3 + 2);
        editor.putInt("set"+trainingSetId+"ex1set4max", set4max >= finalSet1 ? set4max : finalSet4 + 2);
        editor.putInt("set"+trainingSetId+"ex1set5max", set5max >= finalSet1 ? set5max : finalSet5 + 2);
    ...
    private void getWeightFromPreferences(){
        ...
        set1max = prefs.getInt("set"+trainingSetId+"ex1set1max", 5);
        set2max = prefs.getInt("set"+trainingSetId+"ex1set2max", 5);
        set3max = prefs.getInt("set"+trainingSetId+"ex1set3max", 5);
        set4max = prefs.getInt("set"+trainingSetId+"ex1set4max", 5);
        set5max = prefs.getInt("set"+trainingSetId+"ex1set5max", 5);
