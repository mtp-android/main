...
public class Exercise6 extends WizardStep {
    ...
    View.OnClickListener showNumberPickers = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (id) {
                case R.id.editone:
                    reps.setValue(Integer.parseInt(ex6_firstSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex6_firstSetWeightET.getText().toString()));
                    break;
                case R.id.edittwo:
                    reps.setValue(Integer.parseInt(ex6_secondSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex6_secondSetWeightET.getText().toString()));
                    break;
                case R.id.editthree:
                    reps.setValue(Integer.parseInt(ex6_thirdSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex6_thirdSetWeightET.getText().toString()));
                    break;
                case R.id.editfour:
                    reps.setValue(Integer.parseInt(ex6_fourthSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex6_fourthSetWeightET.getText().toString()));
                    break;
                case R.id.editfive:
                    reps.setValue(Integer.parseInt(ex6_fifthSetRepsET.getText().toString()));
                    weight.setValue(Integer.parseInt(ex6_fifthSetWeightET.getText().toString()));
                    break;
                default:
                    break;
            }
    ...
    private void bindDataFields() {
        ...
        editor.putInt("set"+trainingSetId+"ex6set1max", set1max >= finalSet1 ? set1max : finalSet1 + 2);
        editor.putInt("set"+trainingSetId+"ex6set2max", set2max >= finalSet1 ? set2max : finalSet2 + 2);
        editor.putInt("set"+trainingSetId+"ex6set3max", set3max >= finalSet1 ? set3max : finalSet3 + 2);
        editor.putInt("set"+trainingSetId+"ex6set4max", set4max >= finalSet1 ? set4max : finalSet4 + 2);
        editor.putInt("set"+trainingSetId+"ex6set5max", set5max >= finalSet1 ? set5max : finalSet5 + 2);
