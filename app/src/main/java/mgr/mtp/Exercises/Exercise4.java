...
public class Exercise4 extends WizardStep {
    ...
    private void getWeightFromPreferences(){
        ...
        set1max = prefs.getInt("set"+trainingSetId+"ex4set1max", 5);
        set2max = prefs.getInt("set"+trainingSetId+"ex4set2max", 5);
        set3max = prefs.getInt("set"+trainingSetId+"ex4set3max", 5);
        set4max = prefs.getInt("set"+trainingSetId+"ex4set4max", 5);
        set5max = prefs.getInt("set"+trainingSetId+"ex4set5max", 5);
